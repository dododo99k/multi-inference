...
all_results = pickle.load(open(f'./heteo_result/results_{intensity}_{num_proc}.pkl','rb'))
...
for key, val in all_results.items():
    ...
    plt.ylabel('Task')
    # plt.show()
    plt.savefig(f'./heteo_result/{key}_{intensity}_{num_proc}_time.jpg')
    plt.close()
    ...
    plt.ylabel('CDF')
    # plt.show()
    plt.savefig(f'./heteo_result/{key}_{intensity}_{num_proc}_cdf.jpg')
    plt.close()
...
plt.ylabel('CDF')
# plt.show()
plt.savefig(f'./heteo_result/all_{intensity}_{num_proc}_cdf.jpg')
plt.close()
